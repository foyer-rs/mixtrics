...
//! Support for the `opentelemetry` crate version 0.26.
//!
//! Enable the `opentelemetry_0_26` feature to connect the [`metrics`](crate::metrics)
//! traits with OpenTelemetry metrics instruments.
