...
//! Support for the `opentelemetry` crate version 0.27.
//!
//! Enable the `opentelemetry_0_27` feature to instrument applications using the
//! [`metrics`](crate::metrics) traits on top of OpenTelemetry metrics.
